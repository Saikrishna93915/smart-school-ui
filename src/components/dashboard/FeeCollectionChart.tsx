  ...
  if (chartData.length === 0) {
    return (
      <Card className={cn('animate-fade-in', className)}>
        ...
        <CardContent>
          <div className="h-[300px] flex items-center justify-center rounded border border-dashed border-border bg-muted/20">
          ...
          <div className="grid grid-cols-2 gap-4 mt-6">
            ...
            <div className="bg-green-50 dark:bg-green-950 p-3 rounded">
              ...
              <p className="text-lg font-semibold text-green-700 dark:text-green-300">{formatCurrency(0)}</p>
            </div>
            <div className="bg-orange-50 dark:bg-orange-950 p-3 rounded">
              ...
              <p className="text-lg font-semibold text-orange-700 dark:text-orange-300">{formatCurrency(0)}</p>
            </div>
          </div>
        </CardContent>
      </Card>
